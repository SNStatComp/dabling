enrichment_ui <- function(id) {
  ...
  sidebarLayout(
    sidebarPanel(width = 4,
                 ...
                 numericInput(ns("seeds_min_df"), "Min doc freq for seed terms", value = 1, min = 1, step = 1),
                 ...
                 hr(),
                 numericInput(ns("cat_k"), "LLM keywords per category", value = 25, min=3, max=100, step=1),
                 actionButton(ns("btn_enrich_categories"), "Enrich categories with LLM"),
                 hr(),
                 h4("Document enrichment"),
                 numericInput(ns("doc_k"), "LLM keywords per document", value = 10, min=3, max=100, step=1),
